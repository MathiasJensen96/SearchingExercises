...
public class Task2 {
    ...
    public void secondMostCommon() throws FileNotFoundException {
        ...
        c = functions.findSecondMostUsedChar(crypt1);
        ...
        c = functions.findSecondMostUsedChar(crypt2);
        ...
        c = functions.findSecondMostUsedChar(crypt3);
