...
public class Task3 {
    ...
    public void thirdMostCommonLetter() throws FileNotFoundException {
        ...
        c = functions.findThirdMostUsedChar(crypt1);
        ...
        c = functions.findThirdMostUsedChar(crypt2);
        ...
        c = functions.findThirdMostUsedChar(crypt3);
